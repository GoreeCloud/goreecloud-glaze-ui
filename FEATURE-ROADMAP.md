...
| FR-004 | Complete V1.3.1 accessibility and interaction hardening while preserving V1.3.0 Stable behavior, current truth boundaries, and independent consumer conformance. | Critical | Development — dedicated source validation exists; broader exact-head regression repair in PR #176 |
...
| FR-010 | Preserve historical V1.3 candidate-artifact provenance while keeping validators aligned with the current V1.3.0 Stable lifecycle authority and supported rollback path. | Critical | Development — regression repair in PR #176 |
