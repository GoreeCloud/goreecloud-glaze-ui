...
**Current Stable product authority:** GLAZE UI V1.3 — Adaptive Resonance / `1.3.0`.
...
This contract defines how application and service identity assets are constructed, simplified, packaged, validated, and described for tooling across the V1 generation. It originated in GLAZE UI V1.0 and remains inherited by the current V1.3 Stable product unless a later governed contract explicitly supersedes it.
