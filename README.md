...
Automated source-level evidence for the optical material, semantic runtime, composable accessibility runtime, Web renderer, browser capability, and qualification-support slices is provided by five Python validators/regression layers plus `tests/glaze-v1.4-optical-runtime.test.mjs`, `tests/glaze-v1.4-accessibility-composition.test.mjs`, `tests/glaze-v1.4-optical-web.test.mjs`, `tests/glaze-v1.4-browser-capabilities.test.mjs`, and the exact-head `Glaze V1.4 Optical Runtime Candidate` workflow. Exact implementation head `bf1f8a7b44a0df6cccf69115cddd139030c3e110` passed workflow run `34663696760`, including all five V1.4 validators, all five Python regression layers, the blocked/non-promoting qualification-template check, executable runtime/accessibility/Web/browser Node regressions, validator/evaluator compilation, and the no-source-mutation check.
...
Source validation is governed by `scripts/validate_glaze_v1.4_optical_material.py`, `scripts/validate_glaze_v1_4_semantic_optical_runtime.py`, `scripts/validate_glaze_v1_4_browser_capabilities.py`, `scripts/validate_glaze_v1_4_accessibility_composition.py`, `scripts/validate_glaze_v1_4_accessibility_qualification.py`, `scripts/evaluate_glaze_v1_4_accessibility_qualification.py`, their paired Python regressions, the runtime/accessibility/Web/browser Node regressions, and `.github/workflows/glaze-v1.4-optical-material.yml`.
